...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-m&@z85n-a(%3+b_$uslz()jt)#vu_@(dy1n2a@dk9#bxxpb4x4')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ahayee535@gmail.com'
EMAIL_HOST_PASSWORD = 'tocz ksvj sakd vuji'